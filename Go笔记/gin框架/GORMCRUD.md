...
**注意：本文发布于2020-02-16，文中使用的gorm版本有极大概率与你正在使用的不一致，为了更好的使用gorm请移步官方中文文档：https://learnku.com/docs/gorm/v2**
...
func main(){
    dsn:="root:123456@tcp(127.0.0.1:3306)/gormdemo?charset=utf8mb4&parseTime=True&loc=Local"
