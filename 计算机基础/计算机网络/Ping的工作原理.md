...
![ICMP 目标不可达消息](https://cdn.jsdelivr.net/gh/Jason-Wu-1999/blog.img/img/4.jpg)
...
![ICMP 报文](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/ping/5.jpg)
...
<img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/ping/6.jpg" alt="常见的 ICMP 类型" style="zoom: 50%;" />
...
![ICMP 回送消息](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/ping/7.jpg)

可以向对端主机发送**回送请求**的消息（`ICMP Echo Request Message`，类型 `8`），也可以接收对端主机发回来的**回送应答**消息（`ICMP Echo Reply Message`，类型 `0`）。

![ICMP 回送请求和回送应答报文](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/ping/8.jpg)
...
![目标不可达类型的常见代码号](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/ping/9.jpg)
...
![外卖员 —— 小林](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/ping/10.jpg)
...
![ICMP 时间超过消息](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/ping/11.jpg)
...
![主机 A ping 主机 B](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/ping/12.jpg)
...
![主机 A 的 ICMP 回送请求报文](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/ping/13.jpg)
...
![主机 A 的 IP 层数据包](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/ping/14.jpg)

接下来，需要加入 `MAC` 头。如果在本地 ARP 映射表中查找出 IP 地址 192.168.1.2 所对应的 MAC 地址，则可以直接使用；如果没有，则需要发送 `ARP` 协议查询 MAC 地址，获得 MAC 地址后，由数据链路层构建一个数据帧，目的地址是 IP 层传过来的 MAC 地址，源地址则是本机的 MAC 地址；还要附加上一些控制信息，依据以太网的介质访问规则，将它们传送出去。

![主机 A 的 MAC 层数据包](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/ping/15.jpg)
...
![主机 B 的 ICMP 回送响应报文](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/ping/16.jpg)
...
![主机 A ping 主机 B 期间发送的事情](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/ping/17.png)
...
![MTU 路径发现（UDP的情况下）](https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/ping/18.jpg)
